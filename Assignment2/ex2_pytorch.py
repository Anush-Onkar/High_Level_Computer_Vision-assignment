...
if train:
    ...
    for epoch in range(num_epochs):
        for i, (images, labels) in enumerate(train_loader):
            ...
            _, traininig_set_pred = torch.max(output_train, 1)
        ...
        correct_train += (traininig_set_pred == labels).sum().item()
        print('Train accuracy: {} %'.format(100 * correct_train / total_train))
