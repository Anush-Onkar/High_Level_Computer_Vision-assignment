...
num_bins_color = 5
plt.subplot(1,2,2)
hist_rg1 = histogram_module.rg_hist(img_color.astype('double'), num_bins_color)
plt.bar(np.array(range(1,hist_rg1.size+1)),hist_rg1)
plt.show()
...
hist_dxdy1 = histogram_module.dxdy_hist(img_gray.astype('double'), num_bins_color)
plt.bar(np.array(range(1,hist_dxdy1.size+1)),hist_dxdy1)
...
print('number of correct matches in rg_30: %d (%f)\n'% (num_correct, 1.0 * num_correct / len(query_images)))

## Experimenting with different histogram

eval_dist_type = 'intersect';
eval_hist_type = 'grayvalue';
eval_num_bins = 30;
[best_match_grayvalue_30, D_grayvalue_30] = match_module.find_best_match(model_images, query_images, eval_dist_type, eval_hist_type, eval_num_bins)
query_images_vis = [query_images[i] for i in np.array([0,4,9])]
match_module.show_neighbors(model_images, query_images_vis, eval_dist_type, eval_hist_type, eval_num_bins)
num_correct = sum( best_match_grayvalue_30 == range(len(query_images)) )
print('number of correct matches in grayvalue_30: %d (%f)\n'% (num_correct, 1.0 * num_correct / len(query_images)))


eval_dist_type = 'intersect';
eval_hist_type = 'rgb';
eval_num_bins = 30;
[best_match_rgb_30, D_rgb_30] = match_module.find_best_match(model_images, query_images, eval_dist_type, eval_hist_type, eval_num_bins)
query_images_vis = [query_images[i] for i in np.array([0,4,9])]
match_module.show_neighbors(model_images, query_images_vis, eval_dist_type, eval_hist_type, eval_num_bins)
num_correct = sum( best_match_rgb_30 == range(len(query_images)) )
print('number of correct matches in rgb_30: %d (%f)\n'% (num_correct, 1.0 * num_correct / len(query_images)))
...
eval_hist_type = 'dxdy';
eval_num_bins = 30;
[best_match_dxdy_30, D_dxdy_30] = match_module.find_best_match(model_images, query_images, eval_dist_type, eval_hist_type, eval_num_bins)
query_images_vis = [query_images[i] for i in np.array([0,4,9])]
match_module.show_neighbors(model_images, query_images_vis, eval_dist_type, eval_hist_type, eval_num_bins)
num_correct = sum( best_match_dxdy_30 == range(len(query_images)) )
print('number of correct matches in dxdy_30: %d (%f)\n'% (num_correct, 1.0 * num_correct / len(query_images)))


eval_dist_type = 'intersect';
eval_hist_type = 'grayvalue';
eval_num_bins = 10;
[best_match_grayvalue_10, D_grayvalue_10] = match_module.find_best_match(model_images, query_images, eval_dist_type, eval_hist_type, eval_num_bins)
query_images_vis = [query_images[i] for i in np.array([0,4,9])]
match_module.show_neighbors(model_images, query_images_vis, eval_dist_type, eval_hist_type, eval_num_bins)
num_correct = sum( best_match_grayvalue_10 == range(len(query_images)) )
print('number of correct matches in grayvalue_10: %d (%f)\n'% (num_correct, 1.0 * num_correct / len(query_images)))


eval_dist_type = 'intersect';
eval_hist_type = 'rgb';
eval_num_bins = 10;
[best_match_rgb_10, D_rgb_10] = match_module.find_best_match(model_images, query_images, eval_dist_type, eval_hist_type, eval_num_bins)
query_images_vis = [query_images[i] for i in np.array([0,4,9])]
match_module.show_neighbors(model_images, query_images_vis, eval_dist_type, eval_hist_type, eval_num_bins)
num_correct = sum( best_match_rgb_10 == range(len(query_images)) )
print('number of correct matches in rgb_10: %d (%f)\n'% (num_correct, 1.0 * num_correct / len(query_images)))


eval_dist_type = 'intersect';
eval_hist_type = 'rg';
eval_num_bins = 10;
[best_match_rg_10, D_rg_10] = match_module.find_best_match(model_images, query_images, eval_dist_type, eval_hist_type, eval_num_bins)
query_images_vis = [query_images[i] for i in np.array([0,4,9])]
match_module.show_neighbors(model_images, query_images_vis, eval_dist_type, eval_hist_type, eval_num_bins)
num_correct = sum( best_match_rg_10 == range(len(query_images)) )
print('number of correct matches in rg_10: %d (%f)\n'% (num_correct, 1.0 * num_correct / len(query_images)))


eval_dist_type = 'intersect';
eval_hist_type = 'dxdy';
eval_num_bins = 10;
[best_match_dxdy_10, D_dxdy_10] = match_module.find_best_match(model_images, query_images, eval_dist_type, eval_hist_type, eval_num_bins)
query_images_vis = [query_images[i] for i in np.array([0,4,9])]
match_module.show_neighbors(model_images, query_images_vis, eval_dist_type, eval_hist_type, eval_num_bins)
num_correct = sum( best_match_dxdy_10 == range(len(query_images)) )
print('number of correct matches in dxdy_10: %d (%f)\n'% (num_correct, 1.0 * num_correct / len(query_images)))
